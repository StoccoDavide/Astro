function(parse_version_string VERSION_STRING)
  ...
  set(ASTRO_VERSION ${BASE_VERSION} CACHE INTERNAL "")
  set(ASTRO_VERSION_PRERELEASE ${PRE_RELEASE} CACHE INTERNAL "")
endfunction()
...
function(get_version_from_git)
  ...
  set(ASTRO_VERSION "0.0.0" CACHE INTERNAL "")
  set(ASTRO_VERSION_PRERELEASE "" CACHE INTERNAL "")
endfunction()

function(write_version_file)
  if(NOT ASTRO_VERSION)
    message(FATAL_ERROR "ASTRO_VERSION is not set")
  endif()

  set(VERSION_STRING "${ASTRO_VERSION}")
  if(ASTRO_VERSION_PRERELEASE)
    set(VERSION_STRING "${VERSION_STRING}-${ASTRO_VERSION_PRERELEASE}")
  endif()
